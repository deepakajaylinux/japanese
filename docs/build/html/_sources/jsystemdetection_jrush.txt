...
ヘルプ コマンド同様目的に関してユーザーを導くようにシステム検出モジュールに含まれているオプションについて。ヘルプ コマンドはシステムの検出 Jrush モジュールの下に代替パラメーターが一覧表示されます。また、ユーザーのコンピューターを検出するための構文について説明します。システムを検出するための help コマンドを以下に示します。
...
* システムを検出する、ヘルプコマンドを宣言するために使用されるパラメーター大文字小文字が区別されません中に他の人に
  比べて、追加の利点があります。
* It 裕福な両方セント OS とも Ubuntu のように。
