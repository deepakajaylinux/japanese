...
このヘルプ コマンドで、ユーザーは以前のリモート シェル プログラムの欠陥を除去するために設計された 1 つそのようなツールが議論されます。このコマンドの関心の ptconfigure トピックは販売よりも、セキュリティで保護された、phpSSH としてよりもっとよく知られています。次のように助けのためのコマンド
