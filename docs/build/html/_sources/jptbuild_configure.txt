...
.. cssclass:: table-bordered
 ...
 +===========================+===========================+========================+=======================================================+
 |Data directory             | Yes                       | “/opt/Ptbuild”         | それは Ptbuild下ptconfigureをインストールし           |
 |(デフォルト)               |                           |                        |                                                       |
 +---------------------------+---------------------------+------------------------+-------------------------------------------------------+
 |Data directory             | No                        | End slash              | パスを指定するには、ユーザーが持って                  |
 +---------------------------+---------------------------+------------------------+-------------------------------------------------------+
 |Executor directory         | Yes                       | “/usr/bin”             | それは、エグゼキュータディレクトリがインストー        |
 |(デフォルト)               |                           |                        | ルされます                                            |
 +---------------------------+---------------------------+------------------------+-------------------------------------------------------+
