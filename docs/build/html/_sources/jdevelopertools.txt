...
.. cssclass:: table-bordered
 ...
 +========================+================================================+================+===========================================+
 |Install devtools?(Y/N)  | 代わりに使用したの devtools我々は使用すること  | Y(Yes)         | それはptconfigure下のエディタとデータベ   |
 |                        | ができますDeveloperTools, devtools,dev-tools   |                | ースdevtoolsをインストールします          |
 +------------------------+------------------------------------------------+----------------+-------------------------------------------+
 |Install devtools?(Y/N)  | 代わりに使用したの devtools我々は使用すること  | N(No)          | システム出口インストール                  |
 |                        | ができますDeveloperTools, devtools,dev-tools|  |                |                                           |
 +------------------------+------------------------------------------------+----------------+-------------------------------------------+
