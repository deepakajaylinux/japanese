...
.. cssclass:: table-bordered
 ...
 +=======================+==================================+============+===============================================+
 |Install gitlab?(Y/N)   | 我々は使用することができます     | Y(Yes)     | それはgitのをインストールし、                 |
 |                       | Gitlab,gitlab,git-lab            |            | ptconfigure下に共通gitlabのセットになります。 |
 +-----------------------+----------------------------------+------------+-----------------------------------------------+
 |Install gitlab?(Y/N)   | 我々は使用することができます     | N(No)      | システム出口インストール                      |
 |                       | Gitlab,gitlab,git-lab|           |            |                                               |
 +-----------------------+----------------------------------+------------+-----------------------------------------------+
